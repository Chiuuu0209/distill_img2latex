...
class Im2Latex(LightningDataModule):
    ...
    def __init__(
        ...
        self.data_dirname = Path(__file__).resolve().parents[3] / "data"
        ...
        if self.BS:
            BS_formula_file = self.data_dirname / "new_BS_data.lst"
            self.BS_formulas = get_all_formulas(BS_formula_file)
            print("BS formulas : ", len(self.BS_formulas))
        self.transform = {
            "train": A.Compose(
                [
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage in ("fit", None):
            ...
            self.train_dataset = BaseDataset(
                ...
                formulas=self.BS_formulas if self.BS else train_formulas,
